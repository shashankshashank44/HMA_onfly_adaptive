...
private:
    ...
    /* hma declarations */
    int hma_hotness_thold;
    long long int epoch_length;
    int page_size;
...
public:
    ...
    // hma related
	int get_hma_hotness_thold() const {return hma_hotness_thold;};
    long long int get_epoch_length() const {return epoch_length;};
    int get_page_size() const {return page_size;};
    int get_page_transfer_limit() const {return page_transfer_limit;};
    int get_lock_length() const {return lock_length;};
    int get_hot_length() const {return hot_length;};
    int get_num_memories() const {return num_memories;};
	//
