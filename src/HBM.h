...
public:
    ...
    struct SpeedEntry {
      ...
      //{2000, 1000,1.0, 2, 2, 3, 7, 7, 6, 7, 4, 17, 24, 7, 2, 4, 8, 4, 5, 20, 0, 1950, 0, 5, 5, 5, 0}, // only freq is doubled other params not changed
        {2000, 1000,1.0, 2, 2, 3, 14,14,12,14,8, 34, 48, 7, 2, 4, 16,8, 10,40, 0, 3800, 0, 8, 8, 8, 0} // cycle counts changed to care of the change for tCK
    }, speed_entry;
    int read_latency;
